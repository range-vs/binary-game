...
public class Level1_3 extends Task {
    ...
    public Pair generateTask() {
        ...
        String finalNum = "";
        if(index == 0){
            finalNum = String.format("%8s", Integer.toOctalString(number)).replace(' ', '0') + "\u2088";
        }else{
            finalNum = String.format("%8s", Integer.toHexString(number)).replace(' ', '0') + "\u2081\u2086";
        }
